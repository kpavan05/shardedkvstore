...
public final class ShardStorePart1Test extends ShardStoreBaseTest {
    @Test(timeout = 5 * 1000)
    @PrettyTestName("Single group, basic workload - single server")
    ...
    @PrettyTestName("Multi-group join/leave - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    ...
    @PrettyTestName("Shards move when group joins - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    ...
    @Test(timeout = 25 * 1000)
    @PrettyTestName("Shards move when moved by ShardMaster - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    ...
    @PrettyTestName("Repeated shard movement - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
