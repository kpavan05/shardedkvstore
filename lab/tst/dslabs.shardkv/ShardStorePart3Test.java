...
public class ShardStorePart3Test extends ShardStoreBaseTest {
    @Test(timeout = 5 * 1000)
    @PrettyTestName("Single group, simple transactional workload (no swap) - single server")
    ...
    @Test(timeout = 5 * 1000)
    @PrettyTestName("Multi-group, simple transactional workload (no swap) - single server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @PrettyTestName("No progress when groups can't communicate - single server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @Test(timeout = 10 * 1000)
    @PrettyTestName("Isolation between MultiPuts and MultiGets - single server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @PrettyTestName("Repeated MultiPuts and MultiGets, different keys - single server")
    @Category(RunTests.class)
    @TestPointValue(15)
    ...
    @Test(timeout = 5 * 1000)
    @PrettyTestName("Single group, simple transactional workload (no swap) - multi server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @Test(timeout = 5 * 1000)
    @PrettyTestName("Multi-group, simple transactional workload (no swap) - multi server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @Test(timeout = 10 * 1000)
    @PrettyTestName("No progress when groups can't communicate - multi server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @Test(timeout = 10 * 1000)
    @PrettyTestName("Isolation between MultiPuts and MultiGets - multi server")
    @Category(RunTests.class)
    @TestPointValue(10)
    ...
    @Test(timeout = 60 * 1000)
    @PrettyTestName("Repeated MultiPuts and MultiGets, different keys - multi server")
    @Category(RunTests.class)
    @TestPointValue(20)
